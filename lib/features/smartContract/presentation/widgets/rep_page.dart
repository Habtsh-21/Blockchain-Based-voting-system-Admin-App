...
class _PartyPageState extends ConsumerState<PartyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    repList = ref.read(contractProvider.notifier).getReps();

    if (_previousState != contractState && contractState is RepDeletedState) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text("Party: ${rep.partyId}"),
                          Text("State: ${rep.stateId}"),
                          Text(
                            "Total Votes: ${rep.votes}",
                            style: const TextStyle(
                          ...
                          : IconButton(
                              ...
                              onPressed: () async {
                                await ref
                                    ...
                                    .deleteRep(rep.partyId, rep.stateId);
                              },
                            ),
                    ),
                  );
